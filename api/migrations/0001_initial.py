# Generated by Django 4.0.5 on 2022-10-12 19:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unloading_destination', models.CharField(default='', max_length=80)),
                ('loading_origin', models.CharField(default='', max_length=80)),
                ...
                ('status', models.IntegerField(choices=[(4, 'ERROR'), (0, ''), (1, 'PENDING'), (2, 'COMPLETE'), (3, 'CLOSED')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment_size', models.IntegerField(choices=[(0, ''), (1, '40OG'), (2, '20ST'), (3, '40ST'), (4, '20HC'), (5, '40HC')], default=0)),
